...
INSERT INTO `user_tbl` VALUES ('aaa','김짱돌','남성',18,190,89,'여행가기','대구 중구','안녕 난 여행을 좋아해 그렇게 생기지 않았니','ESFP','/man1.png',NULL),('aaz','윤민수','남성',31,184,64,'등산','서울 마포구','안녕하세요! 등산하고 정산에서 코드짜는걸 좋아해요.','INTP','http://localhost:8080/images/9487f3e0-633a-49bd-a949-9e36722c1b8c_man13.png',NULL),('bbb','김곰돌','남성',35,170,100,'애니메이션','부산 사하구','애니다이스키후아후아타임','ISTJ','/man2.png',NULL),('bbx','정윤아','여성',38,155,54,'등산','서울 마포구','지압 자갈 같이 밟을래요?','INTJ','http://localhost:8080/images/8a33e711-755f-41aa-9636-1600840d2bf1_women13.png',NULL),('ccc','김깡패','남성',23,160,90,'음악감상','대전 유성구','가오빼라','ENTP','/man3.png',NULL),('ccv','정현우','남성',35,169,72,'게임','경기 성남시','롤 같이 하실분 누구를위한마스터계정#0000 친추','ESFP','http://localhost:8080/images/3debb420-2402-4586-b9b9-c12a9bf1f110_man14.png',NULL),('ddd','김미남','남성',35,175,70,'요리','서울 마포구','요섹남','ENFP','/man4.png',NULL),('ddw','이지아','여성',25,163,46,'게임','경기 성남시','공포겜 같이 하러 피시방 가요!','ISFP','http://localhost:8080/images/8e5d16e2-4553-4516-988e-b504c641b889_women14.png',NULL),('eee','김장군','여성',21,180,80,'음악감상','서울 송파구','음악 좋아합니다','ISTJ','/women1.png',NULL),('eef','강승우','남성',34,174,77,'독서','부산 해운대구','책 읽고 연체 하는게 제 힐링이에요.','ESFJ','http://localhost:8080/images/7a7d63bb-5e68-4bec-9836-cc870fdc8a30_man15.png',NULL),('fff','김여정','여성',34,170,50,'혁명','북한 평양시','김정은 와이프 닮음','ISFJ','/women2.png',NULL),('fgh','정지아','여성',37,159,50,'독서','부산 해운대구','조용한 공간에서 책 읽는 게 제 힐링이에요.','ESTP','http://localhost:8080/images/2943e7a1-7336-44bc-a93f-3881ece4948d_women15.png',NULL),('ggg','김단발','여성',25,155,45,'격투기','부산 해운대구','안녕 ','ESFJ','/women3.png',NULL),('ggi','정성민','남성',38,168,68,'음악감상','대구 중구','뮤직이즈 마이 라이푸','ISTP','http://localhost:8080/images/fac2d1c9-63fc-4a55-9c0c-c8052dd68d72_man16.png',NULL),('hhh','김표독','여성',37,165,53,'sns','강원도 춘천시','하..','INTJ','/women4.png',NULL),('hhi','강소연','여성',20,155,56,'음악감상','대구 중구','하루의 시작과 끝엔 늘 음악이 함께해요.','ENFP','http://localhost:8080/images/1822ca07-db4f-471b-abe3-285a4202765b_women16.png',NULL),('iii','최범죄','남성',21,182,88,'혁명','경기 수원시','혁명하러 왔습네다','INTJ','/man5.png',NULL),('ijj','임현우','남성',33,184,72,'사진','강원 춘천시','예쁜 풍경과 순간을 사진에 담는 걸 좋아해요.','ESTP','http://localhost:8080/images/38e61394-3b88-44f3-99c8-72765fe6f498_man17.png',NULL),('jjj','김서연','여성',27,150,40,'애니메이션','경기 수원시','라프텔 보면서 가벼운 만남','INTP','/women5.png',NULL),('jkk','이수빈','여성',29,157,50,'사진','강원 춘천시','순간을 담은 사진 좋아해요.','ENFJ','http://localhost:8080/images/44431910-5e26-4f18-9dbe-40a5ba67f867_women17.png',NULL),('junhong','김준홍','남성',27,175,70,'혁명','경기도 안산시','ㅎㅇ','ISTP','http://localhost:8080/images/3848a489-0a06-40a6-9d19-a0b24035c67e_jh.jpg',NULL),('kkk','김도현','남성',28,170,75,'게임','제주 제주시','게임은 그냥 취미 그 이상이에요, 팀플 잘하는 타입입니다!','ENTJ','/man6.png',NULL),('kll','정태윤','남성',38,183,75,'먹방','인천 연수구','한쿡 음식에 콴심이 마나요우','ESFP','http://localhost:8080/images/6fca9ea2-7e49-40b8-9b4a-4bb043a07fda_man18.png',NULL),('lll','이지아','여성',26,170,45,'드라마 감상','경기 안양시','\nDrama is my daily comfort, filming my life is my hobby','ENTP','/women6.png',NULL),('lmm','강지민','여성',34,160,120,'먹방','인천 연수구','햄버거 소믈리에 에요','ENFP','http://localhost:8080/images/9c18190f-d6f4-46db-9fbe-791e1158592d_women18.png',NULL),('mmm','이준서','남성',30,168,50,'패션','경기 안양시','스타일링하는 게 제 힐링이에요, 옷 잘 입는 사람 좋아해요 :)','ENFJ','/man7.png',NULL),('mnn','최현우','남성',23,180,83,'요리','서울 송파구','요리에 마술을~','INTP','http://localhost:8080/images/5cb2c66f-83ec-48b9-a682-916e1cae7922_man19.png',NULL),('nnn','박하은','여성',27,164,44,'여행','대전 유성구','한 달에 한 번은 어디든 떠나요, 여행이 삶의 활력이에요','INFJ','/women7.png',NULL),('nno','강하늘','여성',34,164,43,'요리','서울 송파구','맛있는 걸 함께 만들어 먹는 시간이 좋아요.','ESTP','http://localhost:8080/images/ee70cecf-3d8b-41d4-8799-065c3b20711e_women19.png',NULL),('ooo','이준서','남성',33,177,80,'사진 촬영','경기 성남시','세상을 바꾸는 상상을 자주 해요, 생각 많은 타입이에요','INFJ','/man8.png',NULL),('opp','정태림','남성',32,188,88,'댄스','대전 유성구','음악만 들리면 영혼과 민소매가 먼저 반응해요!','ESFJ','http://localhost:8080/images/668cca3b-4498-4d02-a272-9964b2245a70_man20.png',NULL),('ppp','정수빈','여성',33,155,50,'사진 촬영','경기 성남시','카메라만 들면 집중력이 폭발해요, 예쁜 순간을 남기는 걸 좋아해요!','INFP','/women8.png',NULL),('pqq','강하은닉','여성',21,151,50,'밀리터리 장비수집','대전 유성구','النازيون على حق','ISFJ','http://localhost:8080/images/40a302fb-64a7-4c1e-9102-c09ec15dc43b_women20.png',NULL),('qqq','정하늘','남성',29,180,80,'격투기','북한 평양시','격투기 영상보다가 직접 배우게 됐어요, 운동으로 성격도 유해졌답니다','ENFJ','/man9.png',NULL),('qrr','최강윤','남성',26,168,88,'헬스','경기 고양시','프로틴 추천 받습니다','ENFP','http://localhost:8080/images/91ee411f-1d6e-41c4-ba69-7fe57094d183_man21.png',NULL),('rrr','최예린','여성',30,160,55,'패션','서울 마포구','옷이나 콜라보 보면 못 참아요, 소소한 것에 진심이에요','INFP','/women9.png',NULL),('rss','이다인','여성',35,161,54,'헬스','경기 고양시','매일 런닝 할 사람이 같이 있으면 좋겠어요','ISFP','http://localhost:8080/images/3f8f8fb2-022a-4ed7-810d-30343000994d_women21.png',NULL),('sss','최민재','남성',31,182,90,'운동','서울 송파구','운동으로 스트레스 푸는 게 제일 좋아요, 요즘은 헬스에 빠졌어요!','ESTJ','/man10.png',NULL),('stt','조우진','남성',23,186,74,'여행','전북 전주시','여행 좋아 합니더','ENTJ','http://localhost:8080/images/bfb07137-64d2-47ca-b58f-aad7ab99bb87_man22.png',NULL),('ttt','윤하나','여성',22,162,50,'게임','대구 중구','게임에서 위로받는 걸 좋아해요, 그래서 듀오할사람?','ISFP','/women10.png',NULL),('ttu','한윤아','여성',30,166,55,'여행','전북 전주시','여행 같이 떠나실분~?^^','ISTP','http://localhost:8080/images/8f47f50c-3b27-4aa9-83b7-bea319219378_women22.png',NULL),('uuu','윤태윤','남성',27,170,70,'드라마 감상','부산 해운대구','이어폰 끼고 하루를 시작해요, 드라마는 제 감정상자에요','ISTP','/man11.png',NULL),('uuv','김현우','남성',28,177,98,'밀리터리 장비수집','충남 천안시','Navy SEALs are the strongest in the world!','ISFP','http://localhost:8080/images/70f63a43-cf3d-418a-b2be-be113ff58ca1_man23.png',NULL),('vvv','조민서','여성',29,160,55,'운동','부산 사하구','덤벨을 던지는 게 좋아요, 남들 눈치 안 보는 스타일이에요','ESFP','/women11.png',NULL),('vvw','한수빈','여성',26,156,86,'댄스','충남 천안시','벨리댄스를 배우고 있어요! 그리고 바스크치즈 케이크 먹고 싶어요!','ENTJ','http://localhost:8080/images/0020a35d-c453-4c9f-985f-a2647c86dbc6_women23.png',NULL),('www','조건우','남성',36,180,78,'SNS','강원 춘천시','SNS로 일상 기록하는 거 좋아해요, 요즘은 브이로그도 도전 중이에요!','ENFJ','/man12.png',NULL),('wwx','박민수','남성',20,178,76,'애니메이션','제주 제주시','청춘돼지는 바니걸 꿈을 꾸지 않는다 라는 내용을 아시는 사람?','ISFJ','http://localhost:8080/images/5e33f704-3c1e-418a-a2b6-b66cbc18f128_man24.png',NULL),('xxx','한다인','여성',28,155,50,'요리','제주 제주시','요리는 제 사랑 표현이에요, 새로운 레시피에 도전하는 걸 좋아해요!','ESTJ','/women12.png',NULL),('xxy','강예린','여성',24,155,53,'애니메이션','제주 제주시','바이올렛 에버가든 볼래요?','ISTP','http://localhost:8080/images/e8eb3c53-6144-486a-9e73-499b56d4944f_women24.png',NULL),('yyy','윤현우','남성',27,178,64,'자전거','경북 포항시','바람 가르며 달릴 때 기분 최고예요! 자전거 탈때마다 다시 군인으로 돌아간거 같아요','INFP','http://localhost:8080/images/ed77c1d4-91e8-4cde-af7f-493e6fe0792b_man25.png',NULL),('zzz','강하늘','여성',36,171,54,'자전거','경북 포항시','따릉이 말고 일렉바이크 말고 삼천리','INTP','http://localhost:8080/images/00394208-1f7f-442b-83a6-8830002cf4f4_women25.png',NULL);
...
-- Dump completed on 2025-07-11 15:26:55
